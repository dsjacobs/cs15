 ...
 **************************/
const int DEFAULT_LIST_SIZE =
    10000; // Reduced from 100,000 to avoid stack overflow seg faults
 ...
 **************************/
template <typename T> void printEntry(const string action, const T time);
